...
class CameraHMR(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        pred_smpl_params["global_orient"] = pred_smpl_params["global_orient"].view(
            batch_size, -1, 3, 3
        )
        pred_smpl_params["body_pose"] = pred_smpl_params["body_pose"].view(
            batch_size, -1, 3, 3
        )[:, :NUM_POSE_PARAMS]  # Only use first 21 joints for now
