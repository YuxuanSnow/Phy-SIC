CHECKPOINT_PATH = "data/chmr/camerahmr_checkpoint_cleaned.ckpt"
CAM_MODEL_CKPT = "data/chmr/cam_model_cleaned.ckpt"
SMPL_MEAN_PARAMS_FILE = "data/chmr/smpl_mean_params.npz"
SMPL_MODEL_PATH = "data/body_models/smpl/SMPL_NEUTRAL.pkl"
DETECTRON_CKPT = "data/chmr/model_final_f05665.pkl"
DETECTRON_CFG = "external/CameraHMR/core/utils/cascade_mask_rcnn_vitdet_h_75ep.py"
TRANSFORMER_DECODER = {
    "depth": 6,
    "heads": 8,
    "mlp_dim": 1024,
