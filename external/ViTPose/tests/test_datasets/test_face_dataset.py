...
def test_face_300W_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/300w.py").dataset_info
...
def test_face_AFLW_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/aflw.py").dataset_info
...
def test_face_WFLW_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/wflw.py").dataset_info
