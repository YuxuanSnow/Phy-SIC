...
def test_animal_horse10_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/horse10.py").dataset_info
...
def test_animal_locust_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/locust.py").dataset_info
...
def test_animal_ATRW_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/atrw.py").dataset_info
...
def test_animal_Macaque_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/macaque.py").dataset_info
...
def test_animalpose_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/animalpose.py").dataset_info
...
def test_ap10k_dataset():
    ...
    dataset_class = DATASETS.get(dataset)
    dataset_info = Config.fromfile("configs/_base_/datasets/ap10k.py").dataset_info
