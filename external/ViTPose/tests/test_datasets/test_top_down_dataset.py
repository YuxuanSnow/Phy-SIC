...
def test_top_down_MHP_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/mhp.py").dataset_info
    # test MHP datasets
    dataset_class = DATASETS.get(dataset)
    dataset_class.load_annotations = MagicMock()
    dataset_class.coco = MagicMock()
...
def test_top_down_PoseTrack18_dataset():
    ...
    data_cfg_copy["use_gt_bbox"] = False
    _ = dataset_class(
        ann_file="tests/data/posetrack18/annotations/test_posetrack18_val.json",
    ...
    assert_almost_equal(infos["Total AP"], 0.0)
...
def test_top_down_halpe_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/halpe.py").dataset_info
    # test Halpe datasets
    dataset_class = DATASETS.get(dataset)
    dataset_class.load_annotations = MagicMock()
    dataset_class.coco = MagicMock()
...
def test_top_down_OCHuman_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/ochuman.py").dataset_info
...
def test_top_down_MPII_TRB_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/mpii_trb.py").dataset_info
...
def test_top_down_AIC_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/aic.py").dataset_info
    # test AIC datasets
    dataset_class = DATASETS.get(dataset)
    dataset_class.load_annotations = MagicMock()
    dataset_class.coco = MagicMock()
...
def test_top_down_JHMDB_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/jhmdb.py").dataset_info
    # test JHMDB datasets
    dataset_class = DATASETS.get(dataset)
    dataset_class.load_annotations = MagicMock()
    dataset_class.coco = MagicMock()
...
def test_top_down_h36m_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/h36m.py").dataset_info
    # test AIC datasets
    dataset_class = DATASETS.get(dataset)
    dataset_class.load_annotations = MagicMock()
    dataset_class.coco = MagicMock()
