...
def test_OneHand10K_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/onehand10k.py").dataset_info
...
def test_RHD2D_dataset():
    ...
    dataset_info = Config.fromfile("configs/_base_/datasets/rhd2d.py").dataset_info
