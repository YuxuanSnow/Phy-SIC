...
def test_body3d_mpi_inf_3dhp_dataset():
    ...
    data_cfgs = [
        single_frame_train_data_cfg,
        single_frame_test_data_cfg,
        multi_frame_train_data_cfg,
        multi_frame_test_data_cfg,
    ]
    ...
    for ann_file, data_cfg in zip(ann_files, data_cfgs):
        ...
        np.testing.assert_almost_equal(infos["MPJPE"], 0.0)
        np.testing.assert_almost_equal(infos["P-MPJPE"], 0.0)
        np.testing.assert_almost_equal(infos["3DPCK"], 100.0)
        np.testing.assert_almost_equal(infos["P-3DPCK"], 100.0)
