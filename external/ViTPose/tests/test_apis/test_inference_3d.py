...
def test_pose_lifter_demo():
    ...
    _ = inference_pose_lifter_model(
        pose_model, pose_results_2d, dataset_info=dataset_info, with_track_id=False
    )

    pose_lift_results = inference_pose_lifter_model(
        pose_model, pose_results_2d, dataset_info=dataset_info, with_track_id=True
    )
    ...
    pose_results_2d = [[pose_det_result_0], [pose_det_result_1], [pose_det_result_2]]
...
def test_interhand3d_demo():
    ...
    # test special cases
    # Empty det results
    _ = inference_interhand_3d_model(pose_model, image_name, [], dataset=dataset)
...
def test_body_mesh_demo():
    ...
    config.model.mesh_head.smpl_mean_params = "tests/data/smpl/smpl_mean_params.npz"
