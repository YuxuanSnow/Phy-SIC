...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f"{data_root}/annotations/machine_annot/InterHand2.6M_train_data.json",
    ...
    test=dict(
        type="InterHand2DDataset",
        ann_file=f"{data_root}/annotations/machine_annot/InterHand2.6M_test_data.json",
        camera_file=f"{data_root}/annotations/machine_annot/"
