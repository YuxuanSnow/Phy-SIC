...
# learning policy
lr_config = dict(
    policy="step", warmup="linear", warmup_iters=500, warmup_ratio=0.001, step=[40, 50]
)
total_epochs = 60
log_config = dict(
    interval=20,
...
data = dict(
    ...
    train=dict(
        ...
        camera_file=f"{data_root}/annotations/all/InterHand2.6M_train_camera.json",
        joint_file=f"{data_root}/annotations/all/InterHand2.6M_train_joint_3d.json",
    ...
    val=dict(
        type="InterHand2DDataset",
        ann_file=f"{data_root}/annotations/machine_annot/InterHand2.6M_val_data.json",
    ...
    test=dict(
        ...
        camera_file=f"{data_root}/annotations/all/InterHand2.6M_test_camera.json",
        joint_file=f"{data_root}/annotations/all/InterHand2.6M_test_joint_3d.json",
