...
from .kpt_2d_sview_rgb_img_bottom_up_dataset import Kpt2dSviewRgbImgBottomUpDataset
from .kpt_2d_sview_rgb_img_top_down_dataset import Kpt2dSviewRgbImgTopDownDataset
from .kpt_2d_sview_rgb_vid_top_down_dataset import Kpt2dSviewRgbVidTopDownDataset
...
from .kpt_3d_sview_rgb_img_top_down_dataset import Kpt3dSviewRgbImgTopDownDataset
