...
class DeepFashionDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(
        ...
        if dataset_info is None:
            ...
            if subset == "upper":
                cfg = Config.fromfile("configs/_base_/datasets/deepfashion_upper.py")
                dataset_info = cfg._cfg_dict["dataset_info"]
            elif subset == "lower":
                cfg = Config.fromfile("configs/_base_/datasets/deepfashion_lower.py")
                dataset_info = cfg._cfg_dict["dataset_info"]
            elif subset == "full":
                cfg = Config.fromfile("configs/_base_/datasets/deepfashion_full.py")
                dataset_info = cfg._cfg_dict["dataset_info"]
