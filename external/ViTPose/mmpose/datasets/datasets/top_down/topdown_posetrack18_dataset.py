...
class TopDownPoseTrack18Dataset(TopDownCocoDataset):
    ...
    def evaluate(self, results, res_folder=None, metric="mAP", **kwargs):
        ...
        self._write_posetrack18_keypoint_results(valid_kpts, gt_folder, res_folder)
    ...
    @staticmethod
    def _write_posetrack18_keypoint_results(keypoint_results, gt_folder, pred_folder):
