...
def hrnet_w32(
    pretrained=True,
    pretrained_ckpt="data/deco/pose_hrnet_w32_256x192.pth",
    downsample=False,
    use_conv=False,
):
    cfg = get_cfg_defaults(
        pretrained_ckpt, width=32, downsample=downsample, use_conv=use_conv
    )
...
def hrnet_w48(
    pretrained=True,
    pretrained_ckpt="data/deco/pose_hrnet_w48_256x192.pth",
    downsample=False,
    use_conv=False,
):
    cfg = get_cfg_defaults(
        pretrained_ckpt, width=48, downsample=downsample, use_conv=use_conv
    )
    return get_pose_net(cfg, is_train=True)
